...
import com.daveholman.geartracker.BaseActivity;
import com.daveholman.geartracker.models.Comment;
...
public class GearDetailActivity extends BaseActivity implements View.OnClickListener {

    private static final String TAG = "GearDetailActivity";

    public static final String EXTRA_GEAR_KEY = "gear_key";

    private DatabaseReference mGearReference;
    private DatabaseReference mCommentsReference;
    private ValueEventListener mGearListener;
    private String mGearKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGearKey = getIntent().getStringExtra(EXTRA_GEAR_KEY);
        if (mGearKey == null) {
            throw new IllegalArgumentException("Must pass EXTRA_GEAR_KEY");
        }
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                // Get GearData object and use the values to update the UI
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                // [START_EXCLUDE]
                Toast.makeText(GearDetailActivity.this, "Failed to load gear.",
                        Toast.LENGTH_SHORT).show();
                // [END_EXCLUDE]
            }
        };
        mGearReference.addValueEventListener(postListener);
        // [END post_value_event_listener]

        // Keep copy of post listener so we can remove it when app stops
        mGearListener = postListener;
    ...
    public void onStop() {
        ...
        if (mGearListener != null) {
            mGearReference.removeEventListener(mGearListener);
        }
